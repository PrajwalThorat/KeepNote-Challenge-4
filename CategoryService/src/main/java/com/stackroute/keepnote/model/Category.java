...
public class Category {
    ...
    public String toString() {
        return "Category [categoryCreatedBy=" + categoryCreatedBy + ", categoryCreationDate=" + categoryCreationDate
                + ", categoryDescription=" + categoryDescription + ", categoryName=" + categoryName + ", id=" + id
                + "]";
    }
