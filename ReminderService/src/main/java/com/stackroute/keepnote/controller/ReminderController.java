...
public class ReminderController {
	...
	public ResponseEntity<String> create(@RequestBody Reminder reminder){
		try {
			...
			return new ResponseEntity<String>("successful creation of the reminder" , HttpStatus.CREATED);
	 ...
	 */
	 ...
	 public ResponseEntity<String> delete(@PathVariable String id){
		 try {
			 ...
			 return new ResponseEntity<String>(" reminderId is not found" , HttpStatus.NOT_FOUND);
		 }
	 }
	/*
	...
	public ResponseEntity<?> getById(@PathVariable String id){
		try {
			...
			return new ResponseEntity<String>("reminder found successfully" , HttpStatus.OK);
		} catch (ReminderNotFoundException e) {
		   return new ResponseEntity<String>(" reminderId is not found" , HttpStatus.NOT_FOUND);
		}
	}
	...
	@GetMapping
	public ResponseEntity<?> getAllReminder(@RequestBody Reminder reminder){
		try {
