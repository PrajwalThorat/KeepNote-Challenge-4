...
public class Reminder {
	...
	public String toString() {
		return "Reminder [reminderCreatedBy=" + reminderCreatedBy + ", reminderCreationDate=" + reminderCreationDate
				+ ", reminderDescription=" + reminderDescription + ", reminderId=" + reminderId + ", reminderName="
				+ reminderName + ", reminderType=" + reminderType + "]";
	}
